# Copia de cmake/depends/ceres-solver.cmake de XRSLAM para la web: sin hilos
# (CXX11_THREADS OFF) y sin LAPACK. Define depends::ceres-solver antes que
# XRSLAM, que sólo lo arma si no existe.
if(NOT TARGET depends::ceres-solver)
  ...
  set(CXX11_THREADS OFF CACHE BOOL "" FORCE)
  ...
  set(SCHUR_SPECIALIZATIONS ON CACHE BOOL "" FORCE)
