...
export const Pantalla = {
  girado: false, w: innerWidth, h: innerHeight,
  actualizar() {
    ...
    if (app) {
      ...
      /* de la esquina de arriba a la izquierda, 90° a la derecha, y corrido al borde */
      app.style.transform = this.girado ? `translateX(${vw}px) rotate(90deg)` : '';
    }
  },
  /* de coordenadas de la pantalla (clientX, clientY) a las del juego */
  aJuego(cx, cy) { return this.girado ? { x: cy, y: innerWidth - cx } : { x: cx, y: cy }; },
