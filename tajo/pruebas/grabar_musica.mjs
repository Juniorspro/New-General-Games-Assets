...
const hasta = process.argv[3] ? Number(process.argv[3]) : null;
...
const r = await pg.evaluate(async (h) => await window.grabar(0, 44100, h), hasta);
fs.writeFileSync(`${carpeta}/cancion0.wav`, Buffer.from(r.wav, "base64"));
delete r.wav;
