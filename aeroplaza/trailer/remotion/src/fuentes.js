/* las letras del tráiler (Nunito, la de la interfaz del juego, y Open Sans; OFL): Remotion no dibuja hasta que cargan */
import { cancelRender, continueRender, delayRender, staticFile } from 'remotion';

const espera = delayRender('fuentes');
const caras = [
  new FontFace('Nunito', `url('${staticFile('fuentes/nunito.woff2')}') format('woff2')`, { weight: '400 900' }),
