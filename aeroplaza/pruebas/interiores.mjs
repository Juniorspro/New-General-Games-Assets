...
r = await pag.evaluate(() => {
  ...
  /* (a una hora fija: con la de verdad, los rótulos iban de 13 a 40 según cuándo se corriera. Y mirando
     para un lado fijo: al abrir elige para dónde mirar con la hora de verdad, y a la tarde daba 16-18) */
  if (A.estelario.abierto) { const E = A.estelario; E.ms = Date.UTC(2026, 8, 26, 6, 0, 0); E.vel = 0; E.az = 180; E.alt = 38; E.fov = 70; }
  T.pasos(10);
