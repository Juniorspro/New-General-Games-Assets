...
export const MONTAJES = {
  ...
  kuntur: {
    ...
    yTexto: 1262, ySticker: 1300, tamSticker: 320, yChip: 236, yGancho: 250,
    ...
    lineas: [
      ...
      { sticker: 'guino', pausa: 0.9, planos: [['colores', 2.2, 2.6, [0.38, 0.55, 1.35]], ['nevado', 0.3, 3.2]],
        extras: [{ tipo: 'meme', meme: 'pensalo', texto: 'no te pueden decir que no si no le preguntás a nadie', palabra: 'bueno,', dur: 2.2 }] },
      { sticker: 'bien', planos: [['colores2', 0, 2.2, [0.45, 0.5, 1.3]], ['salinas', 0.3, 3.2, [0.48, 0.48, 1.3]], ['puna', 0.3, 2.6]],
        extras: [{ tipo: 'chip', palabra: 'aletea,', dur: 1.5, texto: '🪽 ALETEA' }, { tipo: 'chip', palabra: 'planea.', dur: 1.2, texto: '🪂 PLANEA' }] },
      { sticker: 'piensa', pausa: 0.8, planos: [['colores2', 0.3, 3.4, [0.45, 0.45, 1.3]], ['tren', 0.4, 4.3]],
        extras: [{ tipo: 'meme', meme: 'shaq', texto: 'Apu mientras Killa hace todo el camino:', palabra: 'Apu,', dur: 2.2 }] },
      { sticker: 'sorpresa', planos: [['colores', 0, 1.4, [0.85, 0.52, 1.5]], ['tren', 2.8, 2.1], ['colores2', 2.6, 2.4, [0.5, 0.35, 1.1]]],
      ...
      { sticker: 'guino', planos: [['puna', 3.0, 2.8], ['nevado', 3.2, 2.6], ['titulo', 2.4, 2.6]],
